# MomScanner v8.06.1 — Trading Guide & README
...
The key improvement is not just win rate — it's that winners are bigger (+0.639% avg vs +0.571%) AND losers are smaller (-0.340% avg vs -0.370%). The structural scoring enters earlier on good moves and avoids false entries on structurally weak setups.
